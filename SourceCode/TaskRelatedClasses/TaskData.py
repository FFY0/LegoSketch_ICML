...
class MetaTask():
    ...
    def to_np(self):
        ...
        self.query_set.sign = self.query_set.sign.numpy()
        self.support_set.sign = self.support_set.sign.numpy()
    def to_tensor(self):
        ...
        self.query_set.sign = torch.tensor(self.query_set.sign)
        self.support_set.sign = torch.tensor(self.support_set.sign)
    def to_device(self):
...
class SupportSet():
    ...
    def __init__(self, support_x, support_y, device, info):
        super().__init__()
...
class QuerySet():
    ...
    def __init__(self, query_x, query_y, device, info):
